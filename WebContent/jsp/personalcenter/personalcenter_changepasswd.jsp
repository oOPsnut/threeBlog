...
<div id="personalcenter_content">
        ...
        <div id="introduce_all">
            ...
            <div id="personalcenter_changepasswd">
                ...
                <div  align="center" id="changepasswd_middle">
                <span>原&ensp;密&ensp;码：</span><input type="password" ><br><br>
                <span>新&ensp;密&ensp;码：</span><input type="password" ><br><br>
                <span>确认密码：</span><input type="password"><br><br>
                <div id="changepasswd_down" align="center">
                <input type="submit" value="保存" id="changeinfo_down_save"/>
                <input type="submit" value="取消" id="changeinfo_down_cancel"/>
                </div>
                <br>
                <br>
                <span>Tips : 为保障账户安全，应养成良好习惯，定期更改密码。</span>
                </div>
            </div>
     	</div>
</div>
