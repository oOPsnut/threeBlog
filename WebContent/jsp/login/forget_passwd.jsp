...
<link rel="stylesheet" href="${pageContext.request.contextPath}/css/forget_passwd.css" type="text/css"/>
...
<script src="${pageContext.request.contextPath}/js/newcheck.js"></script>
<script src="${pageContext.request.contextPath}/js/newcheckform.js"></script>
